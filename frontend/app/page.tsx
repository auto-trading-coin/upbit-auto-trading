            ...
            {!isAuthenticated ? (
                ...
                <>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">총 평가손익</CardTitle>
                                {totalProfitAmount >= 0 ? (
                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">총 평가수익률</CardTitle>
                            ...
                            <CardContent>
                                {portfolioLoading ? (
                                    ...
                                    <>
                                        <div className={`text-2xl font-bold ${getProfitColorClass(totalProfitRate)}`}>
