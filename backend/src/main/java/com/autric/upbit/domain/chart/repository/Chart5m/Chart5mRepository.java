...
public interface Chart5mRepository extends JpaRepository<Chart5m, Long>, Chart5mRepositoryCustom {
     ...
     */
    List<Chart5m> findByMarketAndUnitAndCandleDateTimeKstAfterOrderByCandleDateTimeKstAsc(Market market, Integer unit, LocalDateTime candleDateTimeKst);
     ...
     */
    Optional<Chart5m> findFirstByMarketAndUnitOrderByCandleDateTimeKstDesc(Market market, Integer unit);
}
