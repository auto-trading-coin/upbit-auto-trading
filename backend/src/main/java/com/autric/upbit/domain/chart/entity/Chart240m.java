...
@Entity
@Table(name = "chart_240m")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@ToString
public class Chart240m {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "chart_240m_id")
    private Long id;
    ...
    @Builder
    public Chart240m(Market market, LocalDateTime candleDateTimeKst, BigDecimal openingPrice,
